  ...
  return (
    <>
      <div className="relative mt-20 lg:mt-24">
        <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
          ...
          <div className="flex flex-1 flex-col items-center lg:items-start md:mt-12 lg:mt-0">
            ...
            <p className="text-bk-grey my-4 text-center lg:text-left sm:w-3/4 lg:w-full">
              ...
              officiis incidunt blanditiis porro necessitatibus.
            </p>
        ...
        <div className="hidden md:block bg-bk-purple rounded-r-full h-80 w-2/4 absolute left-0 top-32 lg:top-[45px] lg:left-[-150px]"></div>
      </div>
    </>
  );
};
